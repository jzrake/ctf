...
static void _reconstr(fluid_state **src, fluid_state *L, fluid_state *R, int Q);
...
void _reconstr(fluid_state **src, fluid_state *L, fluid_state *R, int Q)
{
